...
const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'UserClassEdit',
        meta: { title: '班级编辑', noCache: true, activeMenu: '/user/class/list' },
        hidden: true
      },
      {
        path: 'student/list',
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'tag/list',
        component: () => import('@/views/education/tag/list'),
        name: 'EducationTagPage',
        meta: { title: '知识点列表', noCache: true }
      },
      {
        path: 'tag/edit',
        component: () => import('@/views/education/tag/edit'),
        name: 'EducationTagEditPage',
        meta: { title: '知识点编辑', noCache: true, activeMenu: '/education/tag/list' },
        hidden: true
      }
    ]
  },
