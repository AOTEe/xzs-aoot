...
<!--          <el-button type="primary" @click="$router.push({path:'/exam/paper/edit'})">手动组卷</el-button>-->
<!--          <el-button type="primary" @click="$router.push({path:'/exam/paper/autoFormPaper'})">自动组卷</el-button>-->
<!--          <el-button type="primary">添加</el-button>-->
<!--        </el-popover>-->
        <el-popover placement="bottom" trigger="click">
          <el-button type="warning" size="mini" @click="$router.push({path:'/exam/paper/edit'})">手动组卷</el-button>
          <el-button type="warning" size="mini" @click="$router.push({path:'/exam/paper/autoFormPaper'})">自动组卷</el-button>
