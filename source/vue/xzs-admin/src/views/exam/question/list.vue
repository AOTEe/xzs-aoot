<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column prop="tagsName" label="知识点" show-overflow-tooltip width="120px"/>
...
export default {
  ...
  methods: {
    ...
    batchImportQuestion(file){

      console.log(file)
      this.$refs.upload.clearFiles() // 清空file文件,这里的upload是上传组件中的ref="upload"
      ...
      // 其他参数
      questionApi.batchImportQuestion(form).then(data =>{
        alert("导入成功!")
      })
