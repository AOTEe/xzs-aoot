...
public class QuestionController extends BaseApiController {
    ...
    public RestResponse<QuestionEditRequestVM> select(@PathVariable String id) {
    ...
    @RequestMapping(value = "/batchImportQuestion", method = RequestMethod.POST)
    public RestResponse batchImportQuestionFromExcel(@RequestParam("file") MultipartFile multipartFile) {
        ...
        questionService.batchImportQuestionFromExcel(file, getCurrentUser());
        return RestResponse.ok();
    }
