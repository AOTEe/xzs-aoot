...
public class DashboardController extends BaseApiController {
    ...
    public RestResponse<List<TaskItemVm>> task() {
        ...
        List<String> tIds = taskExams.stream().map(taskExam -> taskExam.getId()).collect(Collectors.toList());
    ...
    private List<TaskItemPaperVm> getTaskItemPaperVm(String tFrameId, TaskExamCustomerAnswer taskExamCustomerAnswers) {
