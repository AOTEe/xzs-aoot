...
public class UserController extends BaseWXApiController {
    ...
    public RestResponse<PageInfo<MessageResponseVM>> messagePageList(MessageRequestVM messageRequestVM) {
        ...
        List<String> ids = messageUserPageInfo.getList().stream().map(d -> d.getMessageId()).collect(Collectors.toList());
    ...
    public RestResponse messageDetail(@PathVariable String id) {
    ...
    public RestResponse read(@PathVariable String id) {
