...
public class MessageServiceImpl implements MessageService {
    ...
    @Override
    public List<Message> selectMessageByIds(List<String> ids) {
    ...
    @Override
    public List<MessageUser> selectByMessageIds(List<String> ids) {
    ...
    @Override
    public Message messageDetail(String id) {
        MessageUser messageUser = messageUserMapper.selectByPrimaryKey(id);
